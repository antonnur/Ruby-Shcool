...
# Должна выводить на экран доску 3х3 в текстовом формате с номерами ячеек. 
# И спрашивать:
# "Ваш ход по Х: "
# "Ваш ход по Y: "
...
#Не понял как сделать проверку
#def is_number? obj
#obj.to_s == obj.to_i.to_s
#end
#if is_number? (c) == true && is_number? (l) == true
#оно все время выдает ошибку.
#Поэтому ходы игрока могут перезаписывать ячейки, поэтому игрок должен следить за вводом :(